...
function MelaivaApp() {
  ...
  return (
    <AppShell toast={toast} dismissToast={dismissToast} openAuth={openAuth} setOpenAuth={setOpenAuth} notify={notify}>
      <Routes>
        ...
        <Route path="/dashboard" element={<DashboardPage notify={notify} onOpenAuth={() => setOpenAuth(true)} />} />
        <Route path="/vendor" element={<VendorPage notify={notify} onOpenAuth={() => setOpenAuth(true)} />} />
        <Route path="/vendor/onboarding" element={<VendorOnboardingPage notify={notify} onOpenAuth={() => setOpenAuth(true)} />} />
        <Route path="/auth" element={<AuthPage notify={notify} />} />
